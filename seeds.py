...
martin = Author(fullname="Steve Martin", 
                ...
                born_location="in Waco, Texas, USA", 
...
einstein = Author(fullname="Albert Einstein", 
                  born_date="March 14, 1879", born_location="in Ulm, Germany", 
...
quote1 = Quote(tags=["change", "deep-thoughts", "thinking", "world"], 
               author=einstein, 
               quote="“The world as we have created it is a process of our thinking. It cannot be changed without changing our thinking.”")

quote2 = Quote(tags=["inspirational", "life", "live", "miracle", "miracles"], 
               author=einstein, 
               quote="“There are only two ways to live your life. One is as though nothing is a miracle. The other is as though everything is a miracle.”")

quote3 = Quote(tags=["adulthood", "success", "value"], 
               author=einstein, 
               quote="“Try not to become a man of success. Rather become a man of value.”")

quote4 = Quote(tags=["humor", "obvious", "simile"], 
               author=martin, 
...
quote3.save()
quote4.save()
# Quote.objects.insert([quote1, quote2, quote3, quote4])
